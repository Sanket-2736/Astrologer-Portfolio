      ...
      <div className="w-full max-w-md">
        ...
        <div className="mystic-card p-8">
          <form action={action} className="flex flex-col gap-4">
            ...
            <div>
              <label className="block text-xs uppercase tracking-wide mb-2" style={{ color: 'var(--gold)' }}>Email</label>
              <input
            ...
            <div>
              <label className="block text-xs uppercase tracking-wide mb-2" style={{ color: 'var(--gold)' }}>Password</label>
              <input
          ...
          <p className="text-center text-sm mt-6" style={{ color: 'var(--text-muted)' }}>
            ...
            <Link href="/signup" style={{ color: 'var(--gold-light)' }}>Sign up</Link>
          </p>
        </div>
      </div>
    </div>
